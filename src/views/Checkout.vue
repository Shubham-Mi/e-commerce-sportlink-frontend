        ...
        <table class="table is-fullwidth">
          ...
          <tfoot>
            <tr>
              ...
              <td>Rs. {{ cartTotalPrice.toFixed(2) }}</td>
            </tr>
          </tfoot>
        </table>
      </div>
...
export default {
  ...
  mounted() {
    document.title = "Checkout | Sport-Link";
    this.cart = this.$store.state.cart;

    if (this.cartTotalLength > 0) {
      this.stripe = Stripe(
        "pk_test_51Jbq8KSI2CLaBZo82eOYMUAHSmd7fFXcUCkjtvA7svDH13VTmF4EhoUKSIrHjvAw8moXru0MFBtmkNmq0g1BGMUu00LxoUTNPF"
      );
